    ...
    <div className="flex-1 flex flex-col bg-background">
      <div className="flex-1 flex flex-col gap-4 p-4 overflow-auto">
        <div className="flex-1 flex flex-col border border-border rounded">
          ...
          <DataTable title={t[language].relations} columns={relationsColumns} data={relations} language={language} />
        </div>
        ...
        <div className="flex-1 flex flex-col border border-border rounded">
          ...
          <DataTable title={t[language].noRelations} columns={noRelationsColumns} data={mockNoRelations} language={language} />
        </div>
      </div>
