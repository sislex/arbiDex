...
export class DiscoveryService {
  private readonly table: ApiEndpointDto[] = [
    ...
    {
      method: 'GET',
      path: '/api/quotes/getLastQuotesByMarketIdAndQuoteId/:marketId',
    ...
    {
      method: 'GET',
      path: '/api/quotes/html/getLastQuotesByMarketIdAndQuoteId/:marketId',
    ...
    {
      method: 'GET',
      path: '/api/quotes/getLastQuotesByMarketIdAndQuoteId/:marketId/:quoteId',
      description: 'Get last quotes by market ID',
      tags: ['quotes', 'markets'],
      version: 'v1',
    },
